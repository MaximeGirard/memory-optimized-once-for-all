...
__all__ = ["OFAMobileNetV3CtV3"]


class OFAMobileNetV3CtV3(MobileNetV3):
    def __init__(
        self,
        n_classes=1000,
        bn_param=(0.1, 1e-5),
        ...
        self.stride_stages = [1, 2, 2, 2, 2, 2]
        act_stages = ["relu", "h_swish", "h_swish", "h_swish", "relu", "h_swish"]
        se_stages = [False, False, True, True, False, True]
        ...
        for base_width in base_stage_width[:-2]:
            ...
            # )
            width = int(base_width * self.width_mult)
        ...
        super(OFAMobileNetV3CtV3, self).__init__(
    ...
    def config(self):
        return {
            "name": OFAMobileNetV3CtV3.__name__,
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        super(OFAMobileNetV3CtV3, self).load_state_dict(model_dict)
